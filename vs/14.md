...
**Otázka:** Použité metody testování kvality výsledného software v rámci závěrečné práce; testování uživatelské přívětivosti; automatizace testování a CI/CD (testování uživatelského rozhraní, jednotkové testy atp.)
