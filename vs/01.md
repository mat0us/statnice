...
**Otázka:** Realizace algoritmů v rámci závěrečné práce, použité algoritmy a alternativy jejich implementace; návrh a zpracování dat různých typů v rámci závěrečné práce a související konverze dat; programové moduly a jejich použití.
