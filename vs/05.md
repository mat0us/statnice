...
**Otázka:** Využití šablon abstraktních datových struktur pro uložení dat (rozdíly mezi strukturami, výběr vhodné abstraktní datové
struktury, práce s iterátory); aplikace generických algoritmů a jejich rozšiřitelnost prostřednictvím lambda výrazů
