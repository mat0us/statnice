...
**Otázka:** Existující typy grafů ve 2D a 3D (např. plot, bar, surf, mesh), související funkce pro jejich nastavení, typické příklady užití a možnosti užití pro zobrazení dat v závěrečné práci
