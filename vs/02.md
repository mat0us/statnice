...
**Otázka:** Využití objektové analýzy pro návrh software v rámci závěreční práce (datový, funkční a řídící model, vazby mezi diagramy, UML, diagramy UML a jejich prvky), využití CASE nástrojů
