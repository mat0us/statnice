...
**Otázka:** Využití metodik řízení vývoje softwarových projektů v rámci závěrečné práce s důrazem na agilní metodiky (jaká metodika byla použita, z jakého důvodu, jaké existují alternativy atp.); identifikace vhodné metodiky řízení na základě typu projektu
